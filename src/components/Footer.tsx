...
export default function Footer() {
  return (
    <footer className="text-gray-600 body-font  bg-slate-200 bottom-0 absolute w-screen">
      <div className="mx-auto flex items-center sm:flex-row flex-col p-2 gap-3">
